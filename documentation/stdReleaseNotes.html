...
<cr>
 <h2 align="CENTER">
	 Release 3-6-4 (Sept. XXX, 2021)</h2>
	<ul>
	<li>Fix ODEL logic in devEpidSoftCallback.c.  Same fix make for devEpidSoft.c in R3-6-1.</li>
	</ul>
 <h2 align="CENTER">
	 Release 3-6-3 (Jun. 10, 2021)</h2>
	<ul>
	<li>Scaler code moved to separate SCALER module</li>
	</ul>
